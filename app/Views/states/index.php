...
<div class="card">
  <div class="card-body">
    <div class="mb-3">
      <a href="/states/create" class="btn btn-primary"><i class="bi bi-plus"></i>New State</a>
    </div>
            ...
            <tbody>
              ...
              foreach ($states as $role) : ?>
                <tr>
                  ...
                  <td><?= $role->code ?></td>
                  <td>
                    <a href="/states/edit/<?= $role->id ?>" title="Edit" class="btn btn-warning mb-1"><i class="bi bi-pencil"></i></a>
            ...
            <tbody>
              ...
              foreach ($deleted as $role) : ?>
                <tr>
                  ...
                  <td><?= $role->code ?></td>
                  <td>
                    <a href="<?= base_url('states/restore/' . $role->id); ?>" title="Restore" class="btn btn-secondary">
...
?>
<script>
  const handleDelete = (id) => document.querySelector('#deleteModal .modal-footer a').href = '<?= base_url(); ?>' + 'states/delete/' + id;
  // DataTables
