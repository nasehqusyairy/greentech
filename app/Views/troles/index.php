...
<div class="card">
  <div class="card-body">
    <div class="mb-3">
      <a href="/troles/create" class="btn btn-primary"><i class="bi bi-plus"></i>New tRole</a>
    </div>
...
?>
<script>
  const handleDelete = (id) => document.querySelector('#deleteModal .modal-footer a').href = '<?= base_url(); ?>' + 'troles/delete/' + id;
  // DataTables
