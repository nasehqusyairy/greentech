...
<form action="<?= base_url('permissions/update'); ?>" method="post">
  <?= csrf_field(); ?>
    ...
    <div class="card-body">
      <div class="mb-3">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" id="path" name="path" value="<?= old('path') ?? $permission->path; ?>" placeholder="your/path/here/...">
        </div>
      </div>
