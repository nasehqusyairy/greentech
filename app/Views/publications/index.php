            ...
            <tbody>
              ...
              foreach ($publications as $publication) : ?>
                <tr>
                  ...
                  <td>
                    <a href="/publications/edit/<?= $publication->id ?>" class="btn btn-warning mb-1"><i class="bi bi-pencil"></i></a>
                    <button onclick="handleDelete(<?= $publication->id; ?>)" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="bi bi-trash"></i></button>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
            ...
            <tbody>
              ...
              foreach ($deleted as $publication) : ?>
                <tr>
                  ...
                  <td><?= $publication->name ?></td>
                  <td>
                    <a href="<?= base_url('publications/restore/' . $publication->id); ?>" class="btn btn-secondary">
