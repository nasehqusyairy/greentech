...
<div class="card">
  <div class="card-body">
    <div class="mb-3">
      <a href="/settings/create" class="btn btn-primary"><i class="bi bi-plus"></i>New setting</a>
    </div>
...
?>
<script>
  const handleDelete = (id) => document.querySelector('#deleteModal .modal-footer a').href = '<?= base_url(); ?>' + 'settings/delete/' + id;
  // DataTables
