...
1. MOHAMMAD NASYIKH AL-QUSYAIRY
2. AKHMAD BADAWI
3. RIDWAN JAUHAR KAFABIHI
4. IMAMATUL KHOIRIYAH
5. FITRIA SUSANTI
6. ALDIANA DAMAYANTI
7. FIRDA ARINDA
...
-->
  ...
  <section id="jumbotron" class="py-5 text-center d-flex align-items-center">
    <div class="container">
      ...
      <?php if (!session()->has('user')) : ?>
       <a href="<?= base_url('auth'); ?>" class="btn btn-primary mt-3 btn-lg" data-aos="zoom-in" data-aos-delay="1500">Register</a> 
       <?php else : ?>
       <a href="<?= base_url('profile'); ?>" class="btn btn-primary mt-3 btn-lg" data-aos="zoom-in" data-aos-delay="1500">Register</a> 
       <?php endif; ?>
    </div>
  </section>
  <!-- END OF JUMBOTRON -->
