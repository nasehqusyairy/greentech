...
<form action="<?= base_url('users/store'); ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="card mb-3">
    <div class="card-body">
      ...
      <img src="<?= base_url('assets/img/person-circle.svg'); ?>" id="image-preview" alt="Placeholder Image" width="100" class="img-thumbnail mb-3">
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <div class="input-group">
          <span class="input-group-text" id="phone-addon"><?= old('callingcode'); ?></span>
          <input type="text" class="form-control" id="phone" name="phone" placeholder="81234567890" value="<?= old('phone'); ?>">
        </div>
      </div>
      <div class="mb-3">
